...
\begin{exeresol}
  Considere a hélice circular não uniforme dada por
  \begin{eqnarray*}
  x&=&\cos(t)\\
  y&=&\sin(t)\\
  z&=&f(t):=8\sqrt{t}.\\
...
\end{eqnarray*}
A intepretação intuitiva é que, à medida que o passo da hélice decresce, a curva se aproxima de uma circunferência unitária.  A curvatura se aproxima da curvatura dessa circunferência e a torção se aproxima de zero. Dica: Trace um esboço do gráfico dessa hélice.
  \end{resol}
