...
draw((deslocamento,deslocamento,0)--(1+deslocamento,deslocamento,0),arrow=Arrow3(), L=Label("$y$", position=EndPoint));  
draw((deslocamento,deslocamento,0)--(deslocamento,1+deslocamento,0),arrow=Arrow3(), L=Label("$x$", position=EndPoint)); 
